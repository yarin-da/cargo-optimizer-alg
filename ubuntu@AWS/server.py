...
class RequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        try:
            with open('./heuristic-rch/build/index.html', mode='rb') as html_file:
                html_file_bytes = html_file.read()
                self.send_header('Content-length', len(html_file_bytes))
                self.wfile.write(html_file_bytes)
